...
fdb.set({
  songs: [{ title: 'Things' }, { title: 'Stuff is Good' }, { title: 'OK!' }]
});

ReactDOM.render(React.createElement(Playlist, null), document.getElementById('TADA'));

},{"./app/Playlist":2,"firebase":5,"react":162,"react-dom":6}],2:[function(require,module,exports){
let React = require('react');
    ...
    render: function () {
      return React.createElement(
        ...
        this.state.songs.map(song => {
          return React.createElement(Song, { key: song.title, data: song });
        })
      );
    }
  });
...
},{"./Song":3,"react":162}],3:[function(require,module,exports){
let React = require('react');
